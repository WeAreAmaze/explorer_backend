defmodule Explorer.Chain.Import.Runner.Block.Verifiers do
  @moduledoc """
  ...
  @type imported :: [Block.Verifier.t()]
  ...
  @impl Import.Runner
  def ecto_schema_module, do: Block.Verifier

  @impl Import.Runner
  def option_key, do: :block_verifiers_rewards
  ...
  def run(multi, changes_list, %{timestamps: timestamps} = options) do
    ...
    Multi.run(multi, :block_verifiers_rewards, fn repo, _ ->
  ...
  @spec insert(Repo.t(), [map()], %{
          ...
          {:ok, [Block.Verifier.t()]} | {:error, [Changeset.t()]}
