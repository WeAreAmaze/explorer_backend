defmodule Explorer.RPCTest do
  ...
  @methods %{
    "mtc_blockNumber" => %{
      action: :mtc_block_number,
      notes: nil,
      example: """
      {"id": 0, "jsonrpc": "2.0", "method": "mtc_blockNumber", "params": []}
      """,
      params: [],
      result: """
    ...
    "mtc_getBalance" => %{
      action: :mtc_get_balance,
      notes: """
      The `earliest` parameter will not work as expected currently, because genesis block balances
      are not currently imported
      """,
      example: """
      {"id": 0, "jsonrpc": "2.0", "method": "mtc_getBalance", "params": ["0x0000000000000000000000000000000000000007", "latest"]}
      """,
      params: [
        %{
          name: "Data",
    ...
    "mtc_getLogs" => %{
      ...
      """,
      example: """
      {"id": 0, "jsonrpc": "2.0", "method": "mtc_getLogs",
       "params": [
  ...
  def mtc_get_balance(address_param, block_param \\ nil) do
