defmodule BlockScoutWeb.API.RPC.EthControllerTest do
  ...
  describe "eth_get_logs" do
    ...
    test "with an invalid address", %{conn: conn, api_params: api_params} do
      assert response =
               conn
               |> post("/api/mtc-rpc", params(api_params, [%{"address" => "badhash"}]))
               |> json_response(200)
    ...
    test "address with no logs", %{conn: conn, api_params: api_params} do
      ...
      assert response =
               conn
               |> post("/api/mtc-rpc", params(api_params, [%{"address" => to_string(address.hash)}]))
               |> json_response(200)
  ...
  describe "mtc_get_balance" do
    ...
    test "with an invalid address", %{conn: conn, api_params: api_params} do
      assert response =
               conn
               |> post("/api/mtc-rpc", params(api_params, ["badHash"]))
               |> json_response(200)
    ...
    test "with a valid address that has no balance", %{conn: conn, api_params: api_params} do
      ...
      assert response =
               conn
               |> post("/api/mtc-rpc", params(api_params, [to_string(address.hash)]))
               |> json_response(200)
    ...
    test "with a valid address that has no earliest balance", %{conn: conn, api_params: api_params} do
      ...
      assert response =
               conn
               |> post("/api/mtc-rpc", params(api_params, [to_string(address.hash), "earliest"]))
               |> json_response(200)
    ...
    test "with a valid address and no pending balance", %{conn: conn, api_params: api_params} do
      ...
      assert response =
               conn
               |> post("/api/mtc-rpc", params(api_params, [to_string(address.hash), "pending"]))
               |> json_response(200)
    ...
    test "with a block provided", %{conn: conn, api_params: api_params} do
      ...
      assert response =
               conn
               |> post("/api/mtc-rpc", params(api_params, [to_string(address.hash), "2"]))
               |> json_response(200)
    ...
    test "with a batch of requests", %{conn: conn} do
      ...
      assert response =
               ...
               |> post("/api/mtc-rpc", Jason.encode!(params))
               |> json_response(200)
